...
const addValues = (arr) => {
  // Solution code here...
  let x = arr.reduce((acc, cur, i, arr) => acc + cur, 0);
  return x;
};
...
const addPurchases = (arr) => {
  // Solution code here...
  let x = arr.reduce((acc, cur, i, arr) => acc + cur.purchasePrice, 0);
  return x;
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let x = arr.reduce((acc, cur, i, arr) => {
    return ++acc;
  }, 0);
  return x;
};
...
const countNumberOfChildren = (arr) => {
  // Solution code here...
  let y = arr.reduce((acc, cur, i, arr) => {
    if (cur.children) {
...
const extractChildren = (arr) => {
  ...
  let x = arr.filter((element) =>
    element.name.includes("a") ? element : null
  );
  let y = x.reduce((acc, cur, i, arr) => {
    if (cur.children) {
