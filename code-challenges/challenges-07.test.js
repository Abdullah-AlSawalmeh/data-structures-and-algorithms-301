...
const replaceZeros = (string) => {
  // Solution code here...
  let replaceZeroz = string.replace(/0/g, "zero");
  return replaceZeroz;
};
...
const addOne = (arr) => {
  // Solution code here...
  let arrayPlusOne = arr.map((element) => Number(element) + 1);
  return arrayPlusOne;
};
...
const addQuestion = (arr) => {
  // Solution code here...
  let arrayPlusQM = arr.map((element) => `${element}?`);
  return arrayPlusQM;
};
...
const forLoopTwoToThe = (arr) => {
  ...
  for (let i = 0; i < arr.length; i++) {
    arrayPowerTwo.push(Math.pow(2, Number(arr[i])));
  }
  return arrayPowerTwo;
};
...
const forEachTwoToThe = (arr) => {
  ...
  let arrayPowerTwo = [];
  arr.forEach((element) => arrayPowerTwo.push(Math.pow(2, Number(element))));
  return arrayPowerTwo;
};
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  let arrayPowerTwo = arr.map((element) => Math.pow(2, Number(element)));
  return arrayPowerTwo;
};
...
const charCode = (arr) => {
  // Solution code here...
  let arraycharCodeAt = arr.map((element, i) => element.charCodeAt(0));
  return arraycharCodeAt;
};
...
const evenOdd = (arr) => {
  // Solution code here...
  let arrayEvenOdd = arr.map((element, i) => {
    if (element % 2 === 0) {
      return "even";
    } else if (element % 2 === 1) {
      return "odd";
...
const extractAbilities = (arr) => {
  // Solution code here...
  let arrayAbilitiesName = arr.map((element, i) => element.ability.name);
  return arrayAbilitiesName;
};
...
const extractStats = (arr) => {
  // Solution code here...
  let arrayStats = arr.map((element, i) => {
    return {
